...
challenge3: challenge3.o  find4corner.o transform.o cut.o 
	$(CC) -o challenge3 challenge3.o find4corner.o transform.o cut.o $(CV) $(CORE) $(GUI) $(C++)
...
clean:
	rm -f challenge3 challenge3.o find4corner.o transform.o cut.o
